...
export const ACTION_LISTINGS_REQUEST_GET_START = 'ACTION_LISTINGS_REQUEST_GET_START';
export const ACTION_LISTINGS_REQUEST_GET_SUCCESS = 'ACTION_LISTINGS_REQUEST_GET_SUCCESS';
export const ACTION_LISTINGS_REQUEST_GET_ERROR = 'ACTION_LISTINGS_REQUEST_GET_ERROR';
export const ACTION_LISTINGS_REQUEST_GET_COMPLETE = 'ACTION_LISTINGS_REQUEST_GET_COMPLETE';
